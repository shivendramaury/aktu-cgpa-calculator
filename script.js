...
function updateSemester(container, subjects) {
    ...
    let totalCredits = 0;   // FIX: initialize credit sum
    ...
    subjects.forEach(sub => {
        ...
        totalCredits += sub.credit; // add credits
...
creditBox[0].textContent = `Total Credit: ${creditSum}`;
...
async function downloadPDF(container, semNumber) {
    ...
    pdf.textWithLink(
        ...
        10,
        pdfHeight - 8,
        { url: "https://www.linkedin.com/in/shivendramaury/" }
    );
